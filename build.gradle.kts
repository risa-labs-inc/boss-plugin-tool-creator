...
tasks.register<Jar>("buildPluginJar") {
    archiveFileName.set("boss-plugin-tool-creator-${version}.jar")
    duplicatesStrategy = DuplicatesStrategy.EXCLUDE
    manifest {
        attributes(
            "Implementation-Title" to "BOSS Tool Creator Plugin",
            "Implementation-Version" to version,
            "Main-Class" to "ai.rever.boss.plugin.dynamic.toolcreator.ToolCreatorDynamicPlugin"
        )
    }
